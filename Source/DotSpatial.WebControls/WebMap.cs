                ...
                case "SELECT":
                    {
                        if (m.Layers.SelectedLayer != null)
                        {
                            ...
                            m.Layers.SelectedLayer.ClearSelection(out mapEnv, true);
                            ...
                            m.Layers.SelectedLayer.Select(ex.ToEnvelope(), ex.ToEnvelope(), SelectionMode.Intersects, out affectedarea, ClearStates.Force);
